...
public class StudentVersionService {
    ...
    public List<StudentVersion> getStudentVersionByStudent_Lecturer_Department_DepartmentIdAndVersionType(Long departmentId, String versionType) {
        return studentVersionRepository.findByStudent_Lecturer_Department_DepartmentIdAndVersionType(departmentId, versionType);
    }
